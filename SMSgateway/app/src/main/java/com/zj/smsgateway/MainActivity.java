...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (settings.isValid()){
            ...
            startService(new Intent(this, SendMessageSocketService.class));
            serverStarted = true;
        }
        else {
            Log.d(TAG,"setting is invalid!");
        }
        ...
        findViewById(R.id.save_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(saveSettings() && settings.isValid()){
                    Mail.getInstance().setProperties(settings.getSmtpServer(), settings.getPortNumber(), settings.getEmailAddress(), settings.getPassword(), settings.getEmailRecipient());
                    if (!serverStarted){
                        startService(new Intent(MainActivity.this, SendMessageSocketService.class));
                    }
                }
            }
        });
